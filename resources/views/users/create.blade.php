                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('users.store') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="lastname" type="text" class="form-control @error('name') is-invalid @enderror" name="lastname" value="{{ old('lastname') }}" required autocomplete="lasatname" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="age" type="age" class="form-control @error('name') is-invalid @enderror" name="age" required autocomplete="age" autofocus>
